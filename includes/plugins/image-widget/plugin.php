...
class Swifty_Img_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct(
			...
			__( 'Insertar Imagen', $this->get_widget_slug() ),
			array(
				'classname'  => $this->get_widget_slug().'-class',
				'description' => __( 'Carga imágenes fácilmente mediante widgets.', $this->get_widget_slug() )
			)
		);
	...
	public function register_admin_scripts() {
		...
		wp_enqueue_script( 'admin-script', get_template_directory_uri(). '/includes/plugins/image-widget/js/admin.js' );
